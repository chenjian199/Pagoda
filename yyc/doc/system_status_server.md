...
**3. 根据 `DYN_LORA_ENABLED` 决定是否挂载 LoRA 路由**
...
| `/v1/loras` | GET / POST | 仅在 `DYN_LORA_ENABLED=true` 时注册，分别对应 list / load |
| `/v1/loras/{*lora_name}` | DELETE | 仅在 `DYN_LORA_ENABLED=true` 时注册，对应 unload |
